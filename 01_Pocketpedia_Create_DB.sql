...
CREATE TABLE [Bugs] (
  ...
  -- CONSTRAINT [FK_Bugs_UserProfile] FOREIGN KEY ([UserProfileId]) REFERENCES [UserProfile] ([Id]),
  -- CONSTRAINT [FK_Bugs_Location] FOREIGN KEY ([LocationId]) REFERENCES [Location] ([Id]),
  -- CONSTRAINT [FK_Bugs_SeasonAvailbility] FOREIGN KEY ([SeasonAvailbilityId]) REFERENCES [SeasonAvailbility] ([Id])
)
GO
...
CREATE TABLE [Fish] (
  ...
  -- CONSTRAINT [FK_Fish_UserProfile] FOREIGN KEY ([UserProfileId]) REFERENCES [UserProfile] ([Id]),
  -- CONSTRAINT [FK_Fish_Location] FOREIGN KEY ([LocationId]) REFERENCES [Location] ([Id]),
  -- CONSTRAINT [FK_Fish_SeasonAvailabilityId] FOREIGN KEY ([SeasonAvailbilityId]) REFERENCES [SeasonAvailbility] ([Id])
)
GO
...
CREATE TABLE [SeaCreatures] (
  ...
  -- CONSTRAINT [FK_SeaCreatures_UserProfile] FOREIGN KEY ([UserProfileId]) REFERENCES [UserProfile] ([Id]),
  -- CONSTRAINT [FK_SeaCreatures_SeasonAvailabilityId] FOREIGN KEY ([SeasonAvailbilityId]) REFERENCES [SeasonAvailbility] ([Id])
...
CREATE TABLE [Fossils] (
  ...
  -- CONSTRAINT [FK_Fossils_UserProfile] FOREIGN KEY ([UserProfileId]) REFERENCES [UserProfile] ([Id]),
)
GO
...
CREATE TABLE [Art] (
  ...
  -- CONSTRAINT [FK_Art_UserProfile] FOREIGN KEY ([UserProfileId]) REFERENCES [UserProfile] ([Id]),
)
GO
...
CREATE TABLE [Villagers] (
  ...
  -- CONSTRAINT [FK_Villagers_UserProfile] FOREIGN KEY ([UserProfileId]) REFERENCES [UserProfile] ([Id]),
)
GO
...
CREATE TABLE [Notes] (
  ...
  -- CONSTRAINT [FK_Notes_UserProfile] FOREIGN KEY ([UserProfileId]) REFERENCES [UserProfile] ([Id]),
)
GO
